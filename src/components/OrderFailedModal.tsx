...
export default function OrderFailedModal({isOpen, setIsOpen}: OrderFailedModalProps) {
  function closeModal() {
    setIsOpen(false);
  }
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-500">
                    Please refresh your browser and try again. If this keeps happening please DM <a target="_blank" href="https://www.instagram.com/sanicaswim/" className="text-ss-blue underline decoration-wavy underline-offset-4 hover:underline hover:decoration-wavy sm:no-underline">@SanicaSwim</a> a screenshot of your order form.
                  </p>
                </div>
